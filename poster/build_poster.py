...
def tumour_chart(c):
    days = c["days"]
    ch = Chart(800, 480, (170, 22, 18, 52), (days[0], days[-1]), (-1.5, 11.2))
...
def toxicity_chart(c):
    ...
    ch = Chart(800, 480, (82, 22, 18, 52), (days[0], days[-1]), (0, limit * 1.12))
...
def dose_chart(c):
    ...
    ch = Chart(800, 480, (82, 22, 18, 52), (days[0] - 2, days[-1] + 2), (0, top * 1.12))
